    ...
    while True:
        ...
        if ans:
            ...
            for obj in ans:
                ...
                label_size = cv2.getTextSize(label_text, cv2.FONT_HERSHEY_PLAIN, 1, 3)[0]
                label_left = box_left
                ...
                cv2.rectangle(color_image, (label_left - 1, label_top - 1), (label_right + 1, label_bottom + 1), box_color, -1)
